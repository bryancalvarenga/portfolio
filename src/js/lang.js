  ...
  const translations = {
    pt: {
      ...
      projects: {
        ...
        entrelinhas: {
          title: "Entrelinhas — Escrita assistida por IA",
          desc: "Next.js, NestJS, Prisma, PostgreSQL, JWT. Plataforma de escrita com agentes de IA.",
          alt: "Preview do Entrelinhas",
          demo: "Demo",
          code: "Código",
          view: "Ver projeto",
          modal: {
            title: "Entrelinhas — Escrita assistida por IA",
            coverAlt: "Interface do Entrelinhas com editor de texto e sugestões geradas por IA",
            coverCaption: "Preview da aplicação em desenvolvimento com integração de agentes.",
            sections: {
              contexto: "Contexto",
              desafios: "Principais desafios",
              aprendizados: "Aprendizados",
            ...
            content: {
              contexto:
                "O Entrelinhas é uma aplicação experimental focada em explorar novas formas de escrita assistida por inteligência artificial. O projeto foi desenvolvido utilizando um monorepo e contou com o uso de agentes (Claude Code) capazes de interagir diretamente com o ambiente de desenvolvimento, auxiliando na construção do sistema. A proposta é investigar um fluxo de criação onde humano e IA colaboram na organização, expansão e refinamento de ideias em tempo real.",
              desafios: [
                "Integrar agentes de IA ao fluxo de desenvolvimento e uso da aplicação.",
                "Projetar uma arquitetura escalável utilizando NestJS no backend e Next.js no frontend.",
                "Gerenciar autenticação segura com JWT.",
                "Modelar dados com Prisma garantindo flexibilidade para conteúdos dinâmicos.",
                "Orquestrar comunicação entre frontend, backend e serviços de IA.",
              ],
              aprendizados: [
                "Uso prático de agentes de IA no desenvolvimento de software.",
                "Estruturação de aplicações modernas com Next.js + NestJS em monorepo.",
                "Implementação de autenticação baseada em JWT.",
                "Modelagem de banco de dados com Prisma e PostgreSQL.",
                "Pensamento orientado a produto ao explorar novas interfaces de escrita.",
              ],
            },
          },
        },
    ...
    en: {
      ...
      projects: {
        ...
        entrelinhas: {
          title: "Entrelinhas — AI-assisted Writing Platform",
          desc: "Next.js, NestJS, Prisma, PostgreSQL, JWT. AI-powered writing and idea refinement.",
          alt: "Preview of Entrelinhas",
          demo: "Demo",
          code: "Code",
          view: "View project",
          modal: {
            title: "Entrelinhas — AI-assisted Writing Platform",
            coverAlt: "Entrelinhas interface with text editor and AI-generated suggestions",
            coverCaption: "Application preview with integrated AI agents.",
            sections: {
              contexto: "Context",
              desafios: "Key challenges",
              aprendizados: "Key learnings",
            ...
            content: {
              contexto:
                "Entrelinhas is an experimental application designed to explore new forms of AI-assisted writing. The project was built using a monorepo architecture and leverages AI agents (via Claude Code) capable of interacting directly with the development environment. Its core idea is to create a collaborative workflow where human thinking and AI systems work together to organize, expand, and refine ideas in real time.",
              desafios: [
                "Integrate AI agents into both the development workflow and the application itself.",
                "Design a scalable architecture using NestJS (backend) and Next.js (frontend).",
                "Implement secure authentication using JWT.",
                "Model flexible and dynamic data structures with Prisma.",
                "Coordinate communication between frontend, backend, and AI services.",
              ],
              aprendizados: [
                "Practical use of AI agents in real-world software development.",
                "Structuring modern applications with Next.js and NestJS in a monorepo setup.",
                "Implementing authentication with JWT.",
                "Database modeling using Prisma and PostgreSQL.",
                "Product-oriented thinking when designing new writing experiences.",
              ],
            },
          },
        },
    ...
    es: {
      ...
      projects: {
        ...
        entrelinhas: {
          title: "Entrelinhas — Escritura asistida por IA",
          desc: "Next.js, NestJS, Prisma, PostgreSQL, JWT. Plataforma de escritura con inteligencia artificial.",
          alt: "Vista previa de Entrelinhas",
          demo: "Demo",
          code: "Código",
          view: "Ver proyecto",
          modal: {
            title: "Entrelinhas — Escritura asistida por IA",
            coverAlt: "Interfaz de Entrelinhas con editor de texto y sugerencias generadas por IA",
            coverCaption: "Vista previa de la aplicación con integración de agentes de IA.",
            sections: {
              contexto: "Contexto",
              desafios: "Principales desafíos",
              aprendizados: "Aprendizajes",
              tecnologias: "Tecnologías",
              demoBtn: "Abrir demo",
              repoBtn: "Ver repositorio",
            ...
            content: {
              contexto:
                "Entrelinhas es una aplicación experimental diseñada para explorar nuevas formas de escritura asistida por inteligencia artificial. El proyecto fue desarrollado utilizando una arquitectura monorepo y emplea agentes de IA (a través de Claude Code) capaces de interactuar directamente con el entorno de desarrollo. La propuesta es crear un flujo colaborativo donde el pensamiento humano y los sistemas de IA trabajen juntos para organizar, expandir y refinar ideas en tiempo real.",
              desafios: [
                "Integrar agentes de IA en el flujo de desarrollo y en la propia aplicación.",
                "Diseñar una arquitectura escalable utilizando NestJS en el backend y Next.js en el frontend.",
                "Implementar autenticación segura mediante JWT.",
                "Modelar datos dinámicos y flexibles con Prisma.",
                "Coordinar la comunicación entre frontend, backend y servicios de IA.",
              ],
              aprendizados: [
                "Uso práctico de agentes de IA en el desarrollo de software.",
                "Estructuración de aplicaciones modernas con Next.js y NestJS en un entorno monorepo.",
                "Implementación de autenticación basada en JWT.",
                "Modelado de bases de datos con Prisma y PostgreSQL.",
                "Pensamiento orientado a producto al explorar nuevas experiencias de escritura.",
              ],
            },
          },
        },
    ...
    ja: {
      ...
      projects: {
        ...
        entrelinhas: {
          title: "Entrelinhas — AIによる文章作成支援プラットフォーム",
          desc: "Next.js、NestJS、Prisma、PostgreSQL、JWT。AIを活用したライティング支援。",
          alt: "Entrelinhasのプレビュー",
          demo: "デモ",
          code: "コード",
          view: "プロジェクトを見る",
          modal: {
            title: "Entrelinhas — AIによる文章作成支援プラットフォーム",
            coverAlt: "テキストエディタとAIによる提案が表示されたEntrelinhasの画面",
            coverCaption: "AIエージェントを統合したアプリケーションのプレビュー。",
            sections: {
              contexto: "概要",
              desafios: "主な課題",
              aprendizados: "学び",
            ...
            content: {
              contexto:
                "Entrelinhasは、AIによる文章作成支援の新しい形を探求するための実験的なアプリケーションです。本プロジェクトはモノレポ構成で開発され、Claude Codeを通じてAIエージェントを活用し、開発環境と直接連携しています。人間の思考とAIが協調し、アイデアの整理・拡張・洗練をリアルタイムで行う新しい創作フローの実現を目指しています。",
              desafios: [
                "AIエージェントを開発プロセスおよびアプリケーションに統合すること。",
                "NestJS（バックエンド）とNext.js（フロントエンド）を用いたスケーラブルなアーキテクチャの設計。",
                "JWTによる安全な認証の実装。",
                "Prismaを用いた柔軟なデータモデリング。",
                "フロントエンド、バックエンド、AIサービス間の連携の最適化。",
              ],
              aprendizados: [
                "実践的なAIエージェントの活用経験。",
                "Next.jsとNestJSによるモダンなモノレポ構成の設計。",
                "JWTを用いた認証の実装。",
                "PrismaとPostgreSQLによるデータベース設計。",
                "新しい文章作成体験を探るプロダクト思考の重要性。",
              ],
            },
          },
        },
